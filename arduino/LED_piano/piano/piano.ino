...
void PlayingWithKeys(void) {
  ...
  /////////////////////////////////////////////////////////////////////////////////////////
	...
	if(!(W_pinValues & 0x00000001) && !W_chk[0]) {
		...
		W_chk[0] = true;
		// 여기서 불을 꺼주면 됨.
    if(leds[0] == 1 || leds[0] == 3 || leds[0] == 5 || leds[0] == 9 || leds[0] == 17 || leds[0] == 33 || leds[0] == 65 || leds[0] == 129)
      matching_count++;
	} else { 
	...
	if(!(W_pinValues & 0x00000002) && !W_chk[1]) { 
		...
		W_chk[1] = true;
    if(leds[0] == 2 || leds[0] == 6 || leds[0] == 10 || leds[0] == 18 || leds[0] == 34 || leds[0] == 66 || leds[0] == 130)
      matching_count++;
	} else { 
	...
	if(!(W_pinValues & 0x00000004) && !W_chk[2]) {
		...
		W_chk[2] = true;
    if(leds[0] == 4 || leds[0] == 12 || leds[0] == 20 || leds[0] == 36 || leds[0] == 68 || leds[0] == 132)
      matching_count++;
	} else {
	...
	if(!(W_pinValues & 0x00000008) && !W_chk[3]) {
		...
		W_chk[3] = true;
    if(leds[0] == 8 || leds[0] == 24 || leds[0] == 40 || leds[0] == 72 || leds[0] == 136)
      matching_count++;
	} else {
	...
	if(!(W_pinValues & 0x00000010) && !W_chk[4]) {
		...
		W_chk[4] = true;
    if(leds[0] == 16 || leds[0] == 48 || leds[0] == 80 || leds[0] == 144)
      matching_count++;
	} else {
	...
	if(!(W_pinValues & 0x00000020) && !W_chk[5]) {
		...
		W_chk[5] = true;
    if(leds[0] == 32 || leds[0] == 94 || leds[0] == 160)
      matching_count++;
	} else {
   ...
   if(leds[1] == 16 || leds[1] == 48 || leds[1] == 80 || leds[1] == 144)
	...
	if(!(W_pinValues & 0x00002000) && !W_chk[13]) {
		...
		W_chk[13] = true;
   if(leds[1] == 32 || leds[1] == 94 || leds[1] == 160)
      matching_count++;
	} else {
   ...
   if(leds[1] == 128)
	...
	if(!(W_pinValues & 0x00010000) && !W_chk[16]) {
		...
		W_chk[16] = true;
   if(leds[2] == 1 || leds[2] == 3 || leds[2] == 5 || leds[2] == 9 || leds[2] == 17 || leds[2] == 33 || leds[2] == 65 || leds[2] == 129)
      matching_count++;
	} else {
	...
	if(!(W_pinValues & 0x00020000) && !W_chk[17]) {
		...
		W_chk[17] = true;
   if(leds[2] == 2 || leds[2] == 6 || leds[2] == 10 || leds[2] == 18 || leds[2] == 34 || leds[2] == 66 || leds[2] == 130)
      matching_count++;
	} else {
	...
	if(!(W_pinValues & 0x00040000) && !W_chk[18]) {
		...
		W_chk[18] = true;
   if(leds[2] == 4 || leds[2] == 12 || leds[2] == 20 || leds[2] == 36 || leds[2] == 68 || leds[2] == 132)
      matching_count++;
	} else {
	...
	if(!(W_pinValues & 0x00080000) && !W_chk[19]) {
		...
		W_chk[19] = true;
   if(leds[2] == 8 || leds[2] == 24 || leds[2] == 40 || leds[2] == 72 || leds[2] == 136)
      matching_count++;
	} else {
	...
	if(!(W_pinValues & 0x00100000) && !W_chk[20]) {
		...
		W_chk[20] = true;
   if(leds[2] == 16 || leds[2] == 48 || leds[2] == 80 || leds[2] == 144)
      matching_count++;
	} else {
	...
	if(!(W_pinValues & 0x00200000) && !W_chk[21]) {
		...
		W_chk[21] = true;
   if(leds[2] == 32 || leds[2] == 94 || leds[2] == 160)
      matching_count++;
	} else {
   ...
   if(leds[2] == 128)
	...
	if(!(W_pinValues & 0x01000000) && !W_chk[24]) {
		...
		W_chk[24] = true;
   if(leds[3] == 1 || leds[3] == 3 || leds[3] == 5 || leds[3] == 9 || leds[3] == 17 || leds[3] == 33 || leds[3] == 65 || leds[3] == 129)
      matching_count++;
	} else {
	...
	if(!(W_pinValues & 0x02000000) && !W_chk[25]) {
		...
		W_chk[25] = true;
   if(leds[3] == 2 || leds[3] == 6 || leds[3] == 10 || leds[3] == 18 || leds[3] == 34 || leds[3] == 66 || leds[3] == 130)
      matching_count++;
	} else {
	...
	if(!(W_pinValues & 0x04000000) && !W_chk[26]) {
		...
		W_chk[26] = true;
   if(leds[3] == 4 || leds[3] == 12 || leds[3] == 20 || leds[3] == 36 || leds[3] == 68 || leds[3] == 132)
      matching_count++;
	} else {
	...
	if(!(W_pinValues & 0x08000000) && !W_chk[27]) {
		...
		W_chk[27] = true;
   if(leds[3] == 8 || leds[3] == 24 || leds[3] == 40 || leds[3] == 72 || leds[3] == 136)
      matching_count++;
	} else {
	...
	if(!(W_pinValues & 0x10000000) && !W_chk[28]) {
		...
		W_chk[28] = true;
   if(leds[3] == 16 || leds[3] == 48 || leds[3] == 80 || leds[3] == 144)
      matching_count++;
	} else {
	...
	if(!(W_pinValues & 0x20000000) && !W_chk[29]) {
		...
		W_chk[29] = true;
   if(leds[3] == 32 || leds[3] == 94 || leds[3] == 160)
      matching_count++;
	} else {
...
void getMessage() { // 미구현  
 ...
 // 기본 연습 모드
  ...
  Serial.print("mcount = "); Serial.print(m_count); Serial.print(", matching_count = "); Serial.println(matching_count);
  Serial.print("buf = "); Serial.println(buf);
  Serial.print("bufPosition = "); Serial.println(bufPosition);
  Serial.print("leds => "); Serial.print(leds[0]); Serial.print(" "); Serial.print(leds[1]); Serial.print(" "); Serial.print(leds[2]); Serial.print(" "); Serial.println(leds[3]);
