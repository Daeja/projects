...
//#########################################################
// patched by Seongchuel <acidlab.help@gmail.com>
// for ADJUST blackKeys Value
#define B_ADJ 0xC00000
...
// patched by Seongchuel <acidlab.help@gmail.com>
// BLACK_HELPER DATA
// variable for light on LED, inner black keys.
byte tleds[] = { 0, 0, 0 };
//####################################################
...
//####################################################
// patched by Seongchuel <acidlab.help@gmail.com>
// blackKeys return value
// 
// maybe I think..
// The two pins in the third register of blackKey were open.
// thus they causes a value of 1 for an open pins.
// look below of here. you can understand what I'm said
// [register-pinNumber] : [serialData]
// [1-1]                : 0xC00001
// [1-2]                : 0xC00002
// [1-3]                : 0xC00004
// ...                  : ..
// ...                  : 0xC00400
// ...                  : 0xC80000
// all black key values contain 0xC00000
// so I patched return value
//
// It may not be accurate.
// Please debug and contact me.
//
// B_ADJ was defined 0xC00000 at top of these code.
//
  return( bytesVal | B_ADJ );
//######################################################
}
...
void PlayingWithKeys(void) {
  ...
  if(m_count == matching_count && flag==true) {
    ...
    for(cnt = 0; cnt < 3; cnt++) tleds[cnt] = 0;
...
void upper_leds() {
  if(buf[2] == '2') {
    ...
    else if(buf[4] == 'g') { if(buf[5] == '#') tleds[1] += 1; else if(buf[5] == '$') tleds[0] += 128; else leds[1] += 8; }
    else if(buf[4] == 'a') { if(buf[5] == '#') tleds[1] += 2; else if(buf[5] == '$') tleds[1] += 1; else leds[1] += 16; }
    else if(buf[4] == 'b') { if(buf[5] == '$') tleds[1] += 2; else leds[1] += 32; }
  }
  else if(buf[2] == '4') {
    if(buf[4] == 'c') { if(buf[5] == '#') tleds[1] += 4; else leds[1] += 64; }
    else if(buf[4] == 'd') { if(buf[5] == '#') tleds[1] += 8; else if(buf[5] == '$') tleds[1] += 4; else leds[1] += 128; }
    else if(buf[4] == 'e') { if(buf[5] == '$') tleds[1] += 8; else leds[2] += 1; }
    else if(buf[4] == 'f') { if(buf[5] == '#') tleds[1] += 16; else leds[2] += 2; }
    else if(buf[4] == 'g') { if(buf[5] == '#') tleds[1] += 32; else if(buf[5] == '$') tleds[1] += 16; else leds[2] += 4; }
    else if(buf[4] == 'a') { if(buf[5] == '#') tleds[1] += 64; else if(buf[5] == '$') tleds[1] += 32; else leds[2] += 8; }
    else if(buf[4] == 'b') { if(buf[5] == '$') tleds[1] += 64; else leds[2] += 16; }
  }
  else if(buf[2] == '5') {
    if(buf[4] == 'c') { if(buf[5] == '#') tleds[1] += 128; else leds[2] += 32; }
    else if(buf[4] == 'd') { if(buf[5] == '#') tleds[2] += 1; else if(buf[5] == '$') tleds[1] += 128; else leds[2] += 64; }
    else if(buf[4] == 'e') { if(buf[5] == '$') tleds[2] += 1; else leds[2] += 128; }
    else if(buf[4] == 'f') { if(buf[5] == '#') tleds[2] += 2; else leds[3] += 1; }
    else if(buf[4] == 'g') { if(buf[5] == '#') tleds[2] += 4; else if(buf[5] == '$') tleds[2] += 2; else leds[3] += 2; }
    else if(buf[4] == 'a') { if(buf[5] == '#') tleds[2] += 8; else if(buf[5] == '$') tleds[2] += 4; else leds[3] += 4; }
    else if(buf[4] == 'b') { if(buf[5] == '$') tleds[2] += 8; else leds[3] += 8; }
  }
  else if(buf[2] == '6') {
    if(buf[4] == 'c') { if(buf[5] == '#') tleds[2] += 16; else leds[3] += 16; }
    else if(buf[4] == 'd') { if(buf[5] == '#') tleds[2] += 32; else if(buf[5] == '$') tleds[2] += 16; else leds[3] += 32; }
    else if(buf[4] == 'e') { if(buf[5] == '$') tleds[2] += 32; else leds[3] += 64; }
...
void lower_leds() {
  if(buf[7] == '2') {
    ...
    else if(buf[9] == 'g') { if(buf[10] == '#') tleds[1] += 1; else if(buf[10] == '$') tleds[0] += 128; else leds[1] += 8; }
    else if(buf[9] == 'a') { if(buf[10] == '#') tleds[1] += 2; else if(buf[10] == '$') tleds[1] += 1; else leds[1] += 16; }
    else if(buf[9] == 'b') { if(buf[10] == '$') tleds[1] += 2; else leds[1] += 32; }
  }
  else if(buf[7] == '4') {
    if(buf[9] == 'c') { if(buf[10] == '#') tleds[1] += 4; else leds[1] += 64; }
    else if(buf[9] == 'd') { if(buf[10] == '#') tleds[1] += 8; else if(buf[10] == '$') tleds[1] += 4; else leds[1] += 128; }
    else if(buf[9] == 'e') { if(buf[10] == '$') tleds[1] += 8; else leds[2] += 1; }
    else if(buf[9] == 'f') { if(buf[10] == '#') tleds[1] += 16; else leds[2] += 2; }
    else if(buf[9] == 'g') { if(buf[10] == '#') tleds[1] += 32; else if(buf[10] == '$') tleds[1] += 16; else leds[2] += 4; }
    else if(buf[9] == 'a') { if(buf[10] == '#') tleds[1] += 64; else if(buf[10] == '$') tleds[1] += 32; else leds[2] += 8; }
    else if(buf[9] == 'b') { if(buf[10] == '$') tleds[1] += 64; else leds[2] += 16; }
  }
  else if(buf[7] == '5') {
    if(buf[9] == 'c') { if(buf[10] == '#') tleds[1] += 128; else leds[2] += 32; }
    else if(buf[9] == 'd') { if(buf[10] == '#') tleds[2] += 1; else if(buf[10] == '$') tleds[1] += 128; else leds[2] += 64; }
    else if(buf[9] == 'e') { if(buf[10] == '$') tleds[2] += 1; else leds[2] += 128; }
    else if(buf[9] == 'f') { if(buf[10] == '#') tleds[2] += 2; else leds[3] += 1; }
    else if(buf[9] == 'g') { if(buf[10] == '#') tleds[2] += 4; else if(buf[10] == '$') tleds[2] += 2; else leds[3] += 2; }
    else if(buf[9] == 'a') { if(buf[10] == '#') tleds[2] += 8; else if(buf[10] == '$') tleds[2] += 4; else leds[3] += 4; }
    else if(buf[9] == 'b') { if(buf[10] == '$') tleds[2] += 8; else leds[3] += 8; }
  }
  else if(buf[7] == '6') {
    if(buf[9] == 'c') { if(buf[10] == '#') tleds[2] += 16; else leds[3] += 16; }
    else if(buf[9] == 'd') { if(buf[10] == '#') tleds[2] += 32; else if(buf[10] == '$') tleds[2] += 16; else leds[3] += 32; }
    else if(buf[9] == 'e') { if(buf[10] == '$') tleds[2] += 32; else leds[3] += 64; }
